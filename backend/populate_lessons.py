...
lessons = [
    # English Alphabet A–E
    {
        ...
        "quiz": [{"q": "What letter does Apple start with?", "options": ["A", "B", "C"], "answer": "A"}]
    },
    {
        "level": 1,
        "subject": "English",
        ...
        "quiz": [{"q": "What letter does Ball start with?", "options": ["A", "B", "C"], "answer": "B"}]
    },
    {
        "level": 1,
        "subject": "English",
        ...
        "quiz": [{"q": "What letter does Cat start with?", "options": ["A", "B", "C"], "answer": "C"}]
    },
    {
        "level": 1,
        "subject": "English",
        ...
        "quiz": [{"q": "What letter does Dog start with?", "options": ["C", "D", "E"], "answer": "D"}]
    },
    {
        "level": 1,
        "subject": "English",
        ...
        "quiz": [{"q": "What letter does Egg start with?", "options": ["D", "E", "F"], "answer": "E"}]
    },
    ...
    # Science Basics
    {
        ...
        "quiz": [{"q": "What does a plant need to grow?", "options": ["Water", "Chocolate", "Shoes"], "answer": "Water"}]
    },
    ...
    # Maths Basics
    {
        ...
        "quiz": [{"q": "What is 1 + 1?", "options": ["1", "2", "3"], "answer": "2"}]
    }
]

# Insert lessons and quizzes into SQLite using Django ORM
for l in lessons:
    lesson_obj = Lesson.objects.create(
        title=f"{l['subject']} - {l['chapter']}",
        content="\n".join(l["text"])
    )
    for q in l["quiz"]:
        Quiz.objects.create(
    ...
    print(f"Inserted: {l['subject']} - {l['chapter']}")
